...
<%@ taglib uri="http://www.springframework.org/security/tags"
	prefix="sec"%>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=aa960db744f1352b9127ac727d1ee646&libraries=services"></script>
<script>
	...
	daum.maps.event.addListener(map, 'click', function(mouseEvent) {        
	    ...
	    searchDetailAddrFromCoords(mouseEvent.latLng, function(result, status) {
	        if (status === daum.maps.services.Status.OK) {
	            ...
	            marker.setMap(map);
				$("#aa").val(result[0].address.address_name);
	 ...
	 $("#input-file").on("change",function(event){
			...
			$.ajax({
				...
				success:function(result){
					$("#img").val(result);
					$(".hahaha").html("<img class='aaa' src='/resources/upload/"+result+"'/>");					
				}
			});
		});
});
...
<body>
	...
	<div class="main2">
		...
		<div class="col-md-6 main2Sub text-center">
			<form action="/authority/sellinsert" method="post">
				<input type='hidden' name='${_csrf.parameterName }'
							value='${_csrf.token }' />
				<input type="hidden" id="let" name="let">
				<input type="hidden" id="longs" name="longs">
				...
				<table class="table table-bordered">
					<tr>
						...
						<td><div class="hahaha"></div><br>
							<input type="file" class="form-control" id="input-file" />
						</td>
					</tr>
					<tr>
						<td class="col-md-3"><label class="control-label">제목</label></td>
					...
					<tr>
						...
						<td>
							<select name="cano" class="form-control">
					...
					<tr>
						<td><label>구매가능<br>장소</label></td>
						<td><input type="text" id="aa" name="place" class="form-control"/><br><div id="map" style="width:100%;height:350px;"></div></td>
					</tr>
					<tr>
						<td colspan="2"><input type="submit" value="등록하기" class="btn btn-primary">&nbsp;<input type="reset" value="취소" class="btn btn-danger"></td>
					</tr>
				</table>			
