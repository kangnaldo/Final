	...
	<div class="main2">
		...
		<div class="col-md-6 main2Sub text-center">
			...
			<table class="table">
				...
				<tr>
					<td colspan="2"><input type="submit" value="거래 완료"
						class="btn btn-primary btn-block" data-toggle="modal"
						data-target="#modal" />
						<div class="modal fade" id="modal" tabindex="-1" role="dialog"
							aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<form id="modalform" action="/authority/sellResult2Ok"
									method="post">
									<input type='hidden' name='${_csrf.parameterName }'
										value='${_csrf.token }' /> 
									<input type="hidden" name="sellTenderNo" value="${ bean2.sellTenderNo }" />
				...
				<tr>
					<td colspan="2"><input type="button" onclick="" value="거래 취소"
